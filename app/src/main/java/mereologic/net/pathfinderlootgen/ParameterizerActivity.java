...
public class ParameterizerActivity extends ActionBarActivity implements ParameterizerFragment.Callbacks {
    ...
    public void onRoll(int level) {
        startActivity(new Intent(this, RollerActivity.class).putExtra(RollerActivity.LEVEL, level));
    }
}
